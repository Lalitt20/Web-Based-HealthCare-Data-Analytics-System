...
<body class="theme-cyan login-page authentication"
	style="background-image:url('images/login2.jpg');background-repeat: no-repeat;background-size: 100%">
	<!-- header section -->
	...
	<div class="container">
		...
		<div class="card">
			<h1 class="title"><span>Healthcare</span>Login <span class="msg">Hello, Patient!</span></h1>
			<div class="col-md-12">
